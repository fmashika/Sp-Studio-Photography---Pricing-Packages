...
export const packagesData: PricingPackage[] = [
  ...
  // ================= ADDITION SERVICE PACKAGES (DROP LISTS) =================
  {
    ...
    iconType: 'camera',
    buttonLabel: 'Book Now',
    features: ['Professional additional photographer for comprehensive event coverage.'],
  },
  {
    ...
    iconType: 'video',
    buttonLabel: 'Book Now',
    features: ['Professional additional cinematographer with dedicated 4K camera gear.'],
  },
  {
    ...
    iconType: 'tv',
    buttonLabel: 'Book Now',
    features: ['One 65-inch high-definition LED screen with stand and live video feed.'],
  },
  {
    id: 'addition-drone',
    categoryId: 'addition',
    ...
    iconType: 'camera',
    buttonLabel: 'Book Now',
    features: ['4K aerial cinematography & cinematic landscape drone highlights.'],
  },
  {
    ...
    badge: 'POPULAR',
    buttonLabel: 'Book Now',
    features: ['Interactive 360 rotating video platform with studio lighting & guest cloud gallery.'],
  },
  {
    ...
    iconType: 'heart',
    buttonLabel: 'Book Now',
    features: ['Romantic outdoor/location photoshoot session with edited high-res digital copies.'],
  },
  {
    ...
    iconType: 'gem',
    buttonLabel: 'Book Now',
    features: ['Dedicated engagement ceremony and couple portrait photo coverage.'],
  },
  {
    ...
    iconType: 'sparkles',
    buttonLabel: 'Book Now',
    features: ['Complete photography and videography coverage for kitchen party celebrations.'],
  },
  {
    ...
    iconType: 'star',
    buttonLabel: 'Book Now',
    features: ['5 professionally retouched studio photos with creative backdrops and props.'],
  },
  {
    ...
    iconType: 'camera',
    buttonLabel: 'Book Now',
    features: ['10 high-end retouched studio/outdoor portraits delivered in full resolution.'],
  },
  {
    ...
    iconType: 'camera',
    buttonLabel: 'Book Now',
    features: ['5 studio portrait pictures with professional color grading.'],
  },
  {
    ...
    iconType: 'award',
    buttonLabel: 'Book Now',
    features: ['Hardcover luxury designed A3 photo album with premium luster print pages.'],
  },
  {
    id: 'addition-a4-wood',
    categoryId: 'addition',
    ...
    iconType: 'award',
    buttonLabel: 'Book Now',
    features: ['Custom crafted solid wooden frame in A4 size with UV glass protective finish.'],
  },
  {
    id: 'addition-a3-wood',
    categoryId: 'addition',
    ...
    iconType: 'award',
    buttonLabel: 'Book Now',
    features: ['Custom crafted solid wooden frame in A3 size with high-clarity glass.'],
  },
  {
    id: 'addition-a2-wood',
    categoryId: 'addition',
    ...
    iconType: 'award',
    buttonLabel: 'Book Now',
    features: ['Large format solid wooden frame in A2 size ready for wall mounting.'],
  },
  {
    id: 'addition-a1-wood',
    categoryId: 'addition',
    ...
    iconType: 'award',
    buttonLabel: 'Book Now',
    features: ['Grand exhibition size A1 solid wooden frame with premium metallic brackets.'],
  },
  {
    ...
    iconType: 'gem',
    buttonLabel: 'Book Now',
    features: ['Ultra-glossy crystal clear A3 acrylic glass frame with floating wall spacers.'],
  },
  {
    ...
    iconType: 'gem',
    buttonLabel: 'Book Now',
    features: ['Luxury high-definition A2 acrylic glass frame with diamond-polished edges.'],
  },
  {
    ...
    iconType: 'crown',
    buttonLabel: 'Book Now',
    features: ['Premium executive A1 acrylic frameless glass portrait with luminous depth.'],
  },
];
